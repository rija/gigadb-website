Feature: Curators to manage claims from from gigadb users on dataset authors
	As a curator,
...
Scenario: curators to approve a claim to reconcile a dataset author to a gigadb account
...
Scenario: curators reject a claim on a dataset author after receiving email from claimant
	Given I sign in as an admin
	And I have received an email asking to confirm reconciliation of author "Zhang, G" with user "user@gigadb.org"
...
Scenario: curators reject a claim on a dataset author after receiving an validation email from submitter
	Given I sign in as an admin
	And I have received an email asking to confirm reconciliation of author "Zhang, G" with user "user@gigadb.org"
	And I have received an email from a dataset submitter validating the claim
...
Scenario: curators reject a claim on a dataset author after receiving an invalidation email from submitter
	Given I sign in as an admin
	And I have received an email asking to confirm reconciliation of author "Zhang, G" with user "user@gigadb.org"
